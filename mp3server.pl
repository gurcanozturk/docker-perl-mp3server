...
sub help() {
   ...
   print "\t-p port number. Default is 3000\n";
   ...
   print "\nExample:\n";
   print "\t$0 -l ./playlist\n";
   print "\tUsing default port (3000). Use your WinAmp player and 'Play Location'\n";
   print "\thost.domain.com:3000 and it will magically start streaming.\n\n";
...
message. Here's a summary of each option:
   ...
   -p port to listen on. The default is 3000. Remeber, 
